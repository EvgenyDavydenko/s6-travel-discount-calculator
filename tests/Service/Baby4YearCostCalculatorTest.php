...
class Baby4YearCostCalculatorTest extends TestCase
{
    private $calculator;
    ...
    public function test1_2(): void
    {
        ...
        $totalCost = $this->calculator->calculate($costDetails);
        // (10000 - 80%) - 5%
        $this->assertEquals(1900, $totalCost);
    }
    ...
    public function test1_3(): void
    {
        ...
        $totalCost = $this->calculator->calculate($costDetails);
        // (10000 - 80%) - 3%
        $this->assertEquals(1940, $totalCost);
    }
    ...
    public function test2_1(): void
    {
        ...
        $costDetails = new CostDetailsDto();
        $costDetails->baseCost = 10000;
        $costDetails->participantBirthdate = '2022-10-02';
    ...
    public function test3_1(): void
    {
        ...
        $costDetails = new CostDetailsDto();
        $costDetails->baseCost = 10000;
        $costDetails->participantBirthdate = '2023-01-01';
